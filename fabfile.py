...
def run_manage(command):
    local('/home/vagrant/.virtualenvs/le-code-test/bin/python '
          '/vagrant/testsite/manage.py %s' % command)
...
def requirements():
    local('/home/vagrant/.virtualenvs/le-code-test/bin/pip install -r '
          'requirements.txt ')
